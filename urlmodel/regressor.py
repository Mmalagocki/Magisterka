...
for degree in DEGREES:
    ...
    for fold in folds:
        ...
        #Usuwa zbędne dodatkowe zagnieżdżenie fałd
        training_set = sum(training_set, [])
        validation_set = list(fold.copy())

        fold_error, rubbish = train(training_set, validation_set, degree, CROSS_VALIDATION_LEARNING_RATE,
...
rubbish, best_weights = train(train_data, train_data, degree, TRAINING_LEARNING_RATE, TRAINING_EPOCHS)
